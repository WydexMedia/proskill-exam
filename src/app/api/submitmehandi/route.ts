...
export async function POST(req: Request) {
  try {
    ...
    const correctAnswers: Record<string, string> = {
      "main-ingredient": "Henna powder",
      "plant-part": "Leaf",
      "mix-to-paste": "Water",
      "enhance-color": "Lemon juice",
      "seal-mehndi": "Sugar-lemon mixture",
      "best-duration": "4–6 hours",
      "stain-color": "Orange to dark brown",
      "apply-tool": "Cone",
      "eucalyptus-purpose": "To darken the color",
      "deepen-color": "Steam from cloves",
      "beginner-pattern": "Floral patterns",
      "color-development": "Body heat",
      "avoid-in-cones": "Artificial black dye (PPD)",
      "sugar-purpose": "To help the paste stick better to skin",
      "final-color-factor": "Body temperature and skin type",
    };
